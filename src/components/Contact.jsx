...
export default function Contact() {
    return (
        <section
            ...
            className="section"
        >
            <div className="container lg:grid lg:grid-cols-2 lg:items-center-stretch">
                <div className='mb-12 lg:mb-0 lg:flex lg:flex-col'>
                    ...
                    <p className=' text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]'>
                        Entre em contato comigo para colaboração Entre em contato hoje mesmo para discutir as necessidades do seu projeto e comece a colaborar em algo incrível!
                    </p>
                ...
                <form action="https://getform.io/f/bxowlmra" method="POST" className=' xl:pl-10 2xl:pl-20 '>
                    <div className=" md: grid md: items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            <label htmlFor="name" className="label"> Nome</label>
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Victor Sarti" className='text-field' />
                        </div>

                        <div className="mb-4">
                            <label htmlFor="email" className="label"> Email</label>
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="Sarti@example.com" className='text-field' />
                        </div>
                    ...
                    <div className="mb-4">
                        ...
                        <textarea name="message" id="message" placeholder='Hi!' className='text-field resize-y min-h-32 max-h-80' ></textarea>
                    </div>
